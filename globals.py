...
class Globals:
    def __init__(self):
        ...
        self.bird_jump_delay = 15

        # --- Pipe ---

        self.pipe_initial_count = 1

        self.pipe_texture_width = 2
        self.pipe_texture_height = 1

        self.pipe_padding = 150
        self.pipe_gap_clamp = (100, 200)
        ...
        self.intellect_skin_clamp = (-30, 30)
        self.intellect_weights_clamp = (-0.1, 0.1)
        self.intellect_rate_clamp = (-0.05, 0.05)
...
class Fonts:
    def __init__(self):
        ...
        self.normal = pygame.font.SysFont(self.font, 20, italic=False, bold=False)
        self.italic = pygame.font.SysFont(self.font, 20, italic=True, bold=False)
        self.bold = pygame.font.SysFont(self.font, 20, italic=False, bold=True)
        self.both = pygame.font.SysFont(self.font, 20, italic=True, bold=True)

        self.small_normal = pygame.font.SysFont(self.font, 12, italic=False, bold=False)
        self.small_italic = pygame.font.SysFont(self.font, 12, italic=True, bold=False)
        self.small_bold = pygame.font.SysFont(self.font, 12, italic=False, bold=True)
        self.small_both = pygame.font.SysFont(self.font, 12, italic=True, bold=True)

        self.big_normal = pygame.font.SysFont(self.font, 28, italic=False, bold=False)
        self.big_italic = pygame.font.SysFont(self.font, 28, italic=True, bold=False)
        self.big_bold = pygame.font.SysFont(self.font, 28, italic=False, bold=True)
        self.big_both = pygame.font.SysFont(self.font, 28, italic=True, bold=True)
